...
.badge { padding: 5px 10px; border-radius: 20px; margin: 0 2px; }
.badge.master { background-color: #f70700; color: white; }
.badge.good { background-color: #ae0f7a; color: white; }
...
.close-btn { background:#eeeeee; color: #553377; }
